...
public class AccountServiceImpl extends ServiceImpl<AccountMapper, Account> implements AccountService {
     ...
     */
    @Override
    public String modifyEmail(int userId, ModifyEmailVO modifyEmailVO) {
        ...
        if(account!=null && account.getId()!=userId) return "此邮箱已被他人绑定，无法完成此操作！";
     ...
     */
    @Override
    public String changePassword(int userId, ChangePasswordVO changePasswordVO){
